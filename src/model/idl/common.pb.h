...
constexpr Status Status_MIN = On;
constexpr Status Status_MAX = Off;
...
template <> struct is_proto_enum< ::model::idl::Status> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::model::idl::Status>() {
  return ::model::idl::Status_descriptor();
}
